...
(* OASIS_START *)
(* DO NOT EDIT (digest: 87d62198669cf848dfa7e8b77ebefb95) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Gabriel Scherer"; "J\195\169r\195\180me Vouillon"];
          homepage = None;
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pa_macaque"; "Pa_bananas"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "macaque";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Sql_flatten"; "Sql_internals"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\157\172\222k\r\153\212\166\219A\134pQ\031\170\002";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
