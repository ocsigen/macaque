...
class type bool_array_t = object inherit [bool option list] type_info end
class type int32_array_t = object inherit [int32 option list] type_info end
class type int64_array_t = object inherit [int64 option list] type_info end
class type float_array_t = object inherit [float option list] type_info end
class type string_array_t = object inherit [string option list] type_info end

class type ['t] array_t = object constraint 't = < typ : 'ty; arrayable : unit; .. > inherit ['ty option list] type_info end
...
module Op : sig
  ...
  val array_agg :
    < t : #arrayable_t as 't; .. > group -> < t : 't array_t; nul : nullable > t
